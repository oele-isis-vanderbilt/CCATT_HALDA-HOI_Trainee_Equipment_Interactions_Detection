...
class SetCriterionHOI(nn.Module):
    ...
    def __init__(self, num_obj_classes, num_queries, num_verb_classes, matcher, weight_dict, eos_coef, losses, args):
        ...
        try:
            ...
            print("Error while initializing SetCriterionHOI:", str(e))
            import traceback
            traceback.print_exc()
            raise e  # re-raise the actual error
            #Debugging changes end
        ...
        if args.dataset_file == 'hico':
            ...
            print("dataset should be hico or coco")
            raise
...
class PostProcessHOI(nn.Module):
    ...
    def forward(self, outputs, target_sizes):
        ...
        #Debugging: added comments I guess some where else they used sigmoid of object logits
        ...
        for index in range(len(obj_scores)):
            ...
            # print("Debugging checking - 452 hoi.py program obj_scores[index]",os.shape,os.unsqueeze(1), "vs shape:",vs.shape,"vs value:",vs,
                #   "sb value:",sb.shape,sb, "ob value:",ob.shape,ob)
            ...
            # print("Debugging checking - 460 hoi.py program vs value:",vs, vs.shape)
            ids = torch.arange(b.shape[0])
            # print("Debugging checking - 461 hoi.py program os value:",os, os.shape)
